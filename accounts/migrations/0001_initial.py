# Generated by Django 5.1 on 2026-09-11 16:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', imagekit.models.fields.ProcessedImageField(default='profile_pic/default.jpg', upload_to='profile_pics')),
                ...
                ('status', models.CharField(choices=[('IN', 'Inactive'), ('A', 'Active'), ('OL', 'On leave')], default='IN', max_length=2, verbose_name='Status')),
